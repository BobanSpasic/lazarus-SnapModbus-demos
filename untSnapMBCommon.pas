...
uses
  Classes, SysUtils, Graphics, Grids, untsnapmb;
...
const
  bits_amount = 65536;
  //regs_amount = 65536; //bobby
  regs_amount = 32768; //original
  IoDataSize = 520;
...
procedure InitData;
procedure FillRegGrid(Grid: TStringGrid; Regs: TRegistersArea;
  IdxStart, IdxEnd: integer); overload;
procedure FillRegGrid(Grid: TStringGrid; var Regs: TRegistersArea;
  FillRandom: boolean); overload;
