...
procedure broker_CreateEthernetClient(var Broker: XOBJECT; Proto: integer;
  Address: pansichar; Port: integer);
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
procedure broker_CreateSerialClient(var Broker: XOBJECT; Format: integer;
  PortName: pansichar; BaudRate: integer; Parity: ansichar;
  DataBits, Stops, Flow: integer);
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
procedure broker_Destroy(var Broker: XOBJECT);
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_AddControllerNetDevice(var Broker: XOBJECT; Proto: integer;
  DeviceID: byte; Address: pansichar; Port: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_AddControllerSerDevice(var Broker: XOBJECT; Format: integer;
  DeviceID: byte; PortName: pansichar; BaudRate: integer; Parity: ansichar;
  DataBits, Stops, Flow: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_Connect(var Broker: XOBJECT): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_Disconnect(var Broker: XOBJECT): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_SetLocalParam(var Broker: XOBJECT; LocalID: byte;
  ParamIndex, Value: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_SetRemoteDeviceParam(var Broker: XOBJECT; DeviceID: byte;
  ParamIndex, Value: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_GetIOBufferPtr(var Broker: XOBJECT; DeviceID: byte;
  BufferKind: integer; var Data: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_GetIOBuffer(var Broker: XOBJECT; DeviceID: byte;
  BufferKind: integer; Data: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_GetDeviceStatus(var Broker: XOBJECT; DeviceID: byte;
  var Status: TDeviceStatus): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}

// MODBUS Functions
function broker_ReadHoldingRegisters(var Broker: XOBJECT; DeviceID: byte;
  Address: word; Amount: word; pUsrData: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_WriteMultipleRegisters(var Broker: XOBJECT; DeviceID: byte;
  Address: word; Amount: word; pUsrData: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_ReadCoils(var Broker: XOBJECT; DeviceID: byte;
  Address: word; Amount: word; pUsrData: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_ReadDiscreteInputs(var Broker: XOBJECT; DeviceID: byte;
  Address: word; Amount: word; pUsrData: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_ReadInputRegisters(var Broker: XOBJECT; DeviceID: byte;
  Address: word; Amount: word; pUsrData: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_WriteSingleCoil(var Broker: XOBJECT; DeviceID: byte;
  Address: word; Value: word): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_WriteSingleRegister(var Broker: XOBJECT; DeviceID: byte;
  Address: word; Value: word): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_ReadWriteMultipleRegisters(var Broker: XOBJECT;
  DeviceID: byte; RDAddress, RDAmount, WRAddress, WRAmount: word;
  pRDUsrData: Pointer; pWRUsrData: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_WriteMultipleCoils(var Broker: XOBJECT; DeviceID: byte;
  Address: word; Amount: word; pUsrData: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_MaskWriteRegister(var Broker: XOBJECT; DeviceID: byte;
  Address: word; AND_Mask, OR_Mask: word): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_ReadFileRecord(var Broker: XOBJECT; DeviceID: byte;
  RefType: byte; FileNumber, RecNumber, RegsAmount: word; RecData: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_WriteFileRecord(var Broker: XOBJECT; DeviceID: byte;
  RefType: byte; FileNumber, RecNumber, RegsAmount: word; RecData: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_ReadFIFOQueue(var Broker: XOBJECT; DeviceID: byte;
  Address: word; var FifoCount: word; FIFO: pword): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_ReadExceptionStatus(var Broker: XOBJECT; DeviceID: byte;
  var Data: byte): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_Diagnostics(var Broker: XOBJECT; DeviceID: byte;
  SubFunction: word; pSendData: pword; pRecvData: pword; ItemsToSend: word;
  var ItemsReceived: word): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_GetCommEventCounter(var Broker: XOBJECT; DeviceID: byte;
  var Status: word; var EventCount: word): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_GetCommEventLog(var Broker: XOBJECT; DeviceID: byte;
  var Status: word; var EventCount: word; var MessageCount: word;
  var NumItems: word; Events: pbyte): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_ReportServerID(var Broker: XOBJECT; DeviceID: byte;
  pUsrData: Pointer; var DataSize: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_ExecuteMEIFunction(var Broker: XOBJECT; DeviceID: byte;
  MEI_Type: byte; pWRUsrData: Pointer; WRSize: word; pRDUsrData: Pointer;
  var RDSize: word): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_CustomFunctionRequest(var Broker: XOBJECT; DeviceID: byte;
  ...
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function broker_RawRequest(var Broker: XOBJECT; DeviceID: byte;
  pUsrPDUWrite: Pointer; SizePDUWrite: word; pUsrPDURead: Pointer;
  var SizePDURead: word; SizePDUExpected: word): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
...
type
  ...
  public
    ...
    constructor Create(Format: TMBSerialFormat; PortName: string;
      BaudRate: integer; Parity: char; DataBits, Stops: integer;
      Flow: TMBSerialFlow); overload;

    procedure ChangeTo; overload;
    procedure ChangeTo(Proto: TMBNetProto; Address: string; Port: integer); overload;
    procedure ChangeTo(Format: TMBSerialFormat; PortName: string;
      BaudRate: integer; Parity: char; DataBits, Stops: integer;
      Flow: TMBSerialFlow); overload;

    destructor Destroy; override;
    function AddDevice(Proto: TMBNetProto; DeviceID: byte; Address: string;
      Port: integer): integer; overload;
    function AddDevice(Format: TMBSerialFormat; DeviceID: byte;
      PortName: string; BaudRate: integer; Parity: char; DataBits, Stops: integer;
      Flow: TMBSerialFlow): integer; overload;

    function Connect: integer;
    function Disconnect: integer;

    function SetLocalParam(LocalID: byte; ParamIndex, Value: integer): integer;
      overload;
    function SetLocalParam(ParamIndex, Value: integer): integer; overload;
    function SetRemoteDeviceParam(DeviceID: byte;
      ParamIndex, Value: integer): integer;
      overload;

    function GetBufferSent(DeviceID: byte; Data: Pointer;
      var Size: integer): boolean; overload;
    function GetBufferSent(Data: Pointer; var Size: integer): boolean; overload;
    function GetBufferRecv(DeviceID: byte; Data: Pointer;
      var Size: integer): boolean; overload;
    function GetBufferRecv(Data: Pointer; var Size: integer): boolean; overload;
    // Modbus functions
    function ReadHoldingRegisters(DeviceID: byte; Address: word;
      Amount: word; pUsrData: Pointer): integer;
    function WriteMultipleRegisters(DeviceID: byte; Address: word;
      Amount: word; pUsrData: Pointer): integer;
    function ReadCoils(DeviceID: byte; Address: word; Amount: word;
      pUsrData: Pointer): integer;
    function ReadDiscreteInputs(DeviceID: byte; Address: word;
      Amount: word; pUsrData: Pointer): integer;
    function ReadInputRegisters(DeviceID: byte; Address: word;
      Amount: word; pUsrData: Pointer): integer;
    function WriteSingleCoil(DeviceID: byte; Address: word; Value: word): integer;
    function WriteSingleRegister(DeviceID: byte; Address: word;
      Value: word): integer;
    function ReadWriteMultipleRegisters(DeviceID: byte;
      RDAddress, RDAmount, WRAddress, WRAmount: word; pRDUsrData: Pointer;
      pWRUsrData: Pointer): integer;
    function WriteMultipleCoils(DeviceID: byte; Address: word;
      Amount: word; pUsrData: Pointer): integer;
    function MaskWriteRegister(DeviceID: byte; Address: word;
      AND_Mask, OR_Mask: word): integer;
    function ReadFileRecord(DeviceID: byte; RefType: byte;
      FileNumber, RecNumber, RegsAmount: word; RecData: Pointer): integer;
    function WriteFileRecord(DeviceID: byte; RefType: byte;
      FileNumber, RecNumber, RegsAmount: word; RecData: Pointer): integer;
    function ReadFIFOQueue(DeviceID: byte; Address: word;
      var FifoCount: word; FIFO: pword): integer;
    function ReadExceptionStatus(DeviceID: byte; var Data: byte): integer;
    function Diagnostics(DeviceID: byte; SubFunction: word;
      pSendData: pword; pRecvData: pword; ItemsToSend: word;
      var ItemsReceived: word): integer;
    function GetCommEventCounter(DeviceID: byte; var Status: word;
      var EventCount: word): integer;
    function GetCommEventLog(DeviceID: byte; var Status: word;
      var EventCount: word; var MessageCount: word; var NumItems: word;
      Events: pbyte): integer;
    function ReportServerID(DeviceID: byte; pUsrData: Pointer;
      var DataSize: integer): integer;
    function ExecuteMEIFunction(DeviceID: byte; MEI_Type: byte;
      pWRUsrData: Pointer; WRSize: word; pRDUsrData: Pointer; var RDSize: word): integer;
    function CustomFunctionRequest(DeviceID: byte; UsrFunction: byte;
      pUsrPDUWrite: Pointer; SizePDUWrite: word; pUsrPDURead: Pointer;
      var SizePDURead: word; SizePDUExpected: word): integer;
...
type
  pfn_DeviceEvent = procedure(usrPtr: Pointer; var Event: TSrvEvent; Size: integer);
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_PacketLog = procedure(usrPtr: Pointer; Peer: longword;
    Direction: integer; Data: Pointer; Size: integer);
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_DiscreteInputsRequest = function(usrPtr: Pointer; Address: word;
    Amount: word; Data: Pointer): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_CoilsRequest = function(usrPtr: Pointer; Action: integer;
    Address: word; Amount: word; Data: Pointer): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_InputRegistersRequest = function(usrPtr: Pointer; Address: word;
    Amount: word; Data: Pointer): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_HoldingRegistersRequest = function(usrPtr: Pointer; Action: integer;
    Address: word; Amount: word; Data: Pointer): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_ReadWriteMultipleRegistersRequest = function(usrPtr: Pointer;
    RDAddress: word; RDAmount: word; RDData: Pointer; WRAddress: word;
    WRAmount: word; WRData: Pointer): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_MaskRegisterRequest = function(usrPtr: Pointer; Address: word;
    AND_Mask: word; OR_Mask: word): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_FileRecordRequest = function(usrPtr: Pointer; Action: integer;
    RefType: word; FileNumber: word; RecNumber: word; RegsAmount: word;
    Data: Pointer): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_ExceptionStatusRequest = function(usrPtr: Pointer; var Status: byte): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_DiagnosticsRequest = function(usrPtr: Pointer; SubFunction: word;
    RxItems: Pointer; TxItems: Pointer; ItemsSent: integer;
    var ItemsRecvd: word): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_GetCommEventCounterRequest = function(usrPtr: Pointer; var Status: word;
    var EventCount: word): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_GetCommEventLogRequest = function(usrPtr: Pointer; var Status: word;
    var EventCount: word; var MessageCount: word; Data: Pointer;
    var EventsAmount: word): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_ReportServerIDRequest = function(usrPtr: Pointer; Data: Pointer;
    var DataSize: word): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_ReadFIFOQueueRequest = function(usrPtr: Pointer; PtrAddress: word;
    FIFOValues: Pointer; var FifoCount: word): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_EncapsulatedIT = function(usrPtr: Pointer; MEI_Type: byte;
    MEI_DataReq: pointer; ReqDataSize: word; MEI_DataRes: Pointer;
    var ResDataSize: word): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_UsrFunctionRequest = function(usrPtr: Pointer; UsrFunction: byte;
    RxPDU: Pointer; RxPDUSize: word; TxPDU: Pointer; var TxPDUSize: word): integer;
    {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
  pfn_Passthrough = function(usrPtr: Pointer; DeviceID: byte;
    RxPDU: Pointer; RxPDUSize: word; TxPDU: Pointer; var TxPDUSize: word): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}
...
//******************************************************************************
procedure device_CreateEthernet(var Device: XOBJECT; Proto: integer;
  DeviceID: byte; Address: pansichar; Port: integer);
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
procedure device_CreateSerial(var Device: XOBJECT; Format: integer;
  DeviceID: byte; PortName: pansichar; BaudRate: integer; Parity: ansichar;
  DataBits, Stops, Flow: integer);
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
...
function device_SetParam(var Device: XOBJECT; ParamIndex, Value: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_BindEthernet(var Device: XOBJECT; DeviceID: byte;
  Address: pansichar; Port: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_BindSerial(var Device: XOBJECT; DeviceID: byte;
  PortName: pansichar; BaudRate: integer; Parity: ansichar;
  DataBits, Stops, Flow: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_GetSerialInterframe(var Device: XOBJECT;
  var InterframeDelay: integer; var MaxInterframeDetected: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_AddPeer(var Device: XOBJECT; Address: pansichar): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_SetUserFunction(var Device: XOBJECT; FunctionID: byte;
...
function device_Stop(var Device: XOBJECT): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_RegisterArea(var Device: XOBJECT; AreaID: integer;
  Data: Pointer; Amount: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_CopyArea(var Device: XOBJECT; AreaID: integer;
  Address: word; Amount: word; Data: Pointer; CopyMode: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
...
function device_UnlockArea(var Device: XOBJECT; AreaID: integer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_RegisterCallback(var Device: XOBJECT; CallbackID: integer;
  cbRequest, UsrPtr: Pointer): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_PickEvent(var Device: XOBJECT; var Event: TSrvEvent): integer;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function device_PickEventAsText(var Device: XOBJECT; Text: pansichar;
...
function _ErrorText(Error: integer; Text: pansichar; TextLen: integer): pansichar;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
function _EventText(var Event: TSrvEvent; Text: pansichar;
  TextLen: integer): pansichar;
  {$IFDEF MSWINDOWS} stdcall;{$ELSE}cdecl;{$ENDIF}
...
type
  ...
  private
    Device: XOBJECT;
  public
    constructor Create(Proto: TMBNetProto; DeviceID: byte;
      Address: ansistring; const Port: integer = def_Modbus_Port); overload;
    constructor Create(Format: TMBSerialFormat; DeviceID: byte;
      PortName: ansistring; BaudRate: integer; Parity: ansichar;
      DataBits, Stops: integer; Flow: TMBSerialFlow); overload;
    procedure ChangeTo(Proto: TMBNetProto; DeviceID: byte;
      Address: ansistring; const Port: integer = def_Modbus_Port); overload;
    procedure ChangeTo(Format: TMBSerialFormat; DeviceID: byte;
      PortName: ansistring; BaudRate: integer; Parity: ansichar;
      DataBits, Stops: integer; Flow: TMBSerialFlow); overload;
    destructor Destroy; override;
    function AddPeer(Address: string): integer;
    function Bind(DeviceID: byte; Address: ansistring;
      const Port: integer = def_Modbus_Port): integer; overload;
    function Bind(DeviceID: byte; PortName: ansistring; BaudRate: integer;
      Parity: ansichar; DataBits, Stops, Flow: integer): integer; overload;
    function SetParam(ParamIndex, Value: integer): integer;
    function GetSerialInterframe(var InterframeDelay: integer;
...
//******************************************************************************
procedure broker_CreateFieldController;
  external snaplib name 'broker_CreateFieldController';
procedure broker_CreateEthernetClient;
  external snaplib name 'broker_CreateEthernetClient';
procedure broker_CreateSerialClient;
  external snaplib name 'broker_CreateSerialClient';
procedure broker_Destroy; external snaplib name 'broker_Destroy';
function broker_AddControllerNetDevice;
  external snaplib name 'broker_AddControllerNetDevice';
function broker_AddControllerSerDevice;
  external snaplib name 'broker_AddControllerSerDevice';
function broker_SetLocalParam; external snaplib name 'broker_SetLocalParam';
function broker_SetRemoteDeviceParam;
  external snaplib name 'broker_SetRemoteDeviceParam';
...
function broker_GetIOBufferPtr;
  external snaplib name 'broker_GetIOBufferPtr';
function broker_GetIOBuffer; external snaplib name 'broker_GetIOBuffer';
function broker_GetDeviceStatus;
  external snaplib name 'broker_GetDeviceStatus';
// MODBUS Functions
function broker_ReadHoldingRegisters;
  external snaplib name 'broker_ReadHoldingRegisters';
function broker_WriteMultipleRegisters;
  external snaplib name 'broker_WriteMultipleRegisters';
function broker_ReadCoils; external snaplib name 'broker_ReadCoils';
function broker_ReadDiscreteInputs;
  external snaplib name 'broker_ReadDiscreteInputs';
function broker_ReadInputRegisters;
  external snaplib name 'broker_ReadInputRegisters';
function broker_WriteSingleCoil;
  external snaplib name 'broker_WriteSingleCoil';
function broker_WriteSingleRegister;
  external snaplib name 'broker_WriteSingleRegister';
function broker_ReadWriteMultipleRegisters;
  external snaplib name 'broker_ReadWriteMultipleRegisters';
function broker_WriteMultipleCoils;
  external snaplib name 'broker_WriteMultipleCoils';
function broker_MaskWriteRegister;
  external snaplib name 'broker_MaskWriteRegister';
function broker_ReadFileRecord;
  external snaplib name 'broker_ReadFileRecord';
function broker_WriteFileRecord;
  external snaplib name 'broker_WriteFileRecord';
function broker_ReadFIFOQueue; external snaplib name 'broker_ReadFIFOQueue';
function broker_ReadExceptionStatus;
  external snaplib name 'broker_ReadExceptionStatus';
function broker_Diagnostics; external snaplib name 'broker_Diagnostics';
function broker_GetCommEventCounter;
  external snaplib name 'broker_GetCommEventCounter';
function broker_GetCommEventLog;
  external snaplib name 'broker_GetCommEventLog';
function broker_ReportServerID;
  external snaplib name 'broker_ReportServerID';
function broker_ExecuteMEIFunction;
  external snaplib name 'broker_ExecuteMEIFunction';
function broker_CustomFunctionRequest;
  external snaplib name 'broker_CustomFunctionRequest';
...
constructor TSnapMBBroker.Create(Format: TMBSerialFormat; PortName: string;
  BaudRate: integer; Parity: char; DataBits, Stops: integer; Flow: TMBSerialFlow);
begin
  broker_CreateSerialClient(Broker, Ord(Format), pansichar(PortName),
    BaudRate, ansichar(Parity), DataBits, Stops, Ord(Flow));
end;
...
procedure TSnapMBBroker.ChangeTo(Format: TMBSerialFormat; PortName: string;
  BaudRate: integer; Parity: char; DataBits, Stops: integer; Flow: TMBSerialFlow);
begin
  if Broker.MBObject <> 0 then
    broker_Destroy(Broker);
...
function TSnapMBBroker.CustomFunctionRequest(DeviceID: byte;
  ...
  pUsrPDURead: Pointer; var SizePDURead: word; SizePDUExpected: word): integer;
begin
  Result := broker_CustomFunctionRequest(Broker, DeviceID, UsrFunction,
    pUsrPDUWrite, SizePDUWrite, pUsrPDURead, SizePDURead, SizePDUExpected);
end;

function TSnapMBBroker.GetDeviceStatus(DeviceID: byte): TDeviceStatus;
begin
  broker_GetDeviceStatus(Broker, DeviceID, Result);
end;
...
begin
  Result := broker_AddControllerNetDevice(Broker, Ord(Proto), DeviceID,
    pansichar(Address), Port);
end;
...
begin
  Result := broker_AddControllerSerDevice(Broker, Ord(Format), DeviceID,
    pansichar(PortName), BaudRate, ansichar(Parity), DataBits, Stops, Ord(Flow));
end;

function TSnapMBBroker.Diagnostics(DeviceID: byte; SubFunction: word;
  pSendData: pword; pRecvData: pword; ItemsToSend: word;
  var ItemsReceived: word): integer;
begin
  Result := broker_Diagnostics(Broker, DeviceID, SubFunction, pSendData,
    pRecvData, ItemsToSend, ItemsReceived);
end;
...
function TSnapMBBroker.ExecuteMEIFunction(DeviceID: byte; MEI_Type: byte;
  pWRUsrData: Pointer; WRSize: word; pRDUsrData: Pointer; var RDSize: word): integer;
begin
  Result := broker_ExecuteMEIFunction(Broker, DeviceID, MEI_Type,
    pWRUsrData, WRSize, pRDUsrData, RDSize);
end;
...
function TSnapMBBroker.GetCommEventLog(DeviceID: byte; var Status: word;
  ...
  Events: pbyte): integer;
begin
  Result := broker_GetCommEventLog(Broker, DeviceID, Status, EventCount,
...
function TSnapMBBroker.ReadCoils(DeviceID: byte; Address: word;
  Amount: word; pUsrData: Pointer): integer;
begin
...
function TSnapMBBroker.ReadExceptionStatus(DeviceID: byte; var Data: byte): integer;
begin
...
function TSnapMBBroker.ReadFileRecord(DeviceID: byte; RefType: byte;
  FileNumber, RecNumber, RegsAmount: word; RecData: Pointer): integer;
begin
  Result := broker_ReadFileRecord(Broker, DeviceID, RefType, FileNumber,
    RecNumber, RegsAmount, RecData);
end;
...
function TSnapMBBroker.ReadWriteMultipleRegisters(DeviceID: byte;
  RDAddress, RDAmount, WRAddress, WRAmount: word; pRDUsrData: Pointer;
  pWRUsrData: Pointer): integer;
begin
  Result := broker_ReadWriteMultipleRegisters(Broker, DeviceID,
    RDAddress, RDAmount, WRAddress, WRAmount, pRDUsrData, pWRUsrData);
end;
...
function TSnapMBBroker.SetLocalParam(LocalID: byte;
  ParamIndex, Value: integer): integer;
begin
...
function TSnapMBBroker.SetRemoteDeviceParam(DeviceID: byte;
  ParamIndex, Value: integer): integer;
begin
...
function TSnapMBBroker.WriteFileRecord(DeviceID: byte; RefType: byte;
  FileNumber, RecNumber, RegsAmount: word; RecData: Pointer): integer;
begin
  Result := broker_WriteFileRecord(Broker, DeviceID, RefType, FileNumber,
    RecNumber, RegsAmount, RecData);
end;
...
function TSnapMBBroker.WriteMultipleRegisters(DeviceID: byte;
  Address: word; Amount: word; pUsrData: Pointer): integer;
begin
...
constructor TSnapMBDevice.Create(Format: TMBSerialFormat; DeviceID: byte;
  PortName: ansistring; BaudRate: integer; Parity: ansichar;
  DataBits, Stops: integer; Flow: TMBSerialFlow);
begin
  device_CreateSerial(Device, Ord(Format), DeviceID, pansichar(PortName),
    BaudRate, ansichar(Parity), DataBits, Stops, Ord(Flow));
end;
...
begin
  Result := device_BindSerial(Device, DeviceID, pansichar(PortName),
    BaudRate, Parity, DataBits, Stops, Flow);
end;
...
function TSnapMBDevice.CopyArea(AreaID: integer; Address: word;
  Amount: word; Data: Pointer; CopyMode: integer): integer;
begin
...
function TSnapMBDevice.RegisterCallback(CallbackID: TCallbackID;
  cbRequest, UsrPtr: Pointer): integer;
begin
  Result := device_RegisterCallback(Device, Ord(CallbackID), cbRequest, UsrPtr);
end;

function TSnapMBDevice.SetUserFunction(FunctionID: byte; Value: boolean): integer;
begin
